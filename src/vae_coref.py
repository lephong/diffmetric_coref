...
class CoEn:
    def __init__(self, voca, a_feat_dim, pw_feat_dim, gen_dim, eval=False, k_best=-1):
    ...
    def encoder(self):
        ...
        score_m_link_eps = tf.fill(tf.shape(score_m_link_eps), MIN_FLOAT32) # only for ante detection
        ...
        def _time_step(i, score_m_link_antecedents):
            ...
            # score_m_i_link_antecedents = score_m_i_link_antecedents * (1 - iwi_mask) + iwi_mask * (-50)
    ...
    def train(self, args):
        ...
        # supervised_encoder_cost = self.supervised_ante_detect(score_m_link_antecedents)
        ...
        cost_func = supervised_decoder_cost
        ...
        # writer = tf.train.SummaryWriter("/tmp/graph", graph=tf.get_default_graph())
        # return
        ...
        for epoch in range(args.n_epochs):
            ...
            for id in range(train_data.n_documents):
                ...
                if train_data.get_doc_id(id) % 10 == 0:
